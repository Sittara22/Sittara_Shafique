  ...
  return (
    <div>
      <nav className='navbar'>
         ...
         <button onClick={()=>{document.getElementById('Contact_me').scrollIntoView({behavior:'smooth'})}} className="desktopMenueBtn">
            <img src={contact} alt="contact" className='desktopMenueImg'/>
            Contact Me
         </button>
         <img src={menu} alt="Menu" className='mobMenu' onClick={()=>{setshowMenu(!showMenu)}} />
         <div className="navMenue" style={{display:showMenu?'flex':'none'}}>
